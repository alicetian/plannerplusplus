package edu.calstatela.cs594.data;
...
public class DBAdapter {
	...
	//---------------------------------------------------------
	final static String COLUMN_HOMEWORK_CLASSNAME = "classname";
	final static String COLUMN_HOMEWORK_DESCRIPTION = "description";
	final static String COLUMN_HOMEWORK_DATE = "duedate";
	final static String COLUMN_HOMEWORK_TIME = "duetime";
	//---------------------------------------------------------
	final static String COLUMN_CLASSES_CLASSNAME = "classname";
	final static String COLUMN_CLASSES_DESCRIPTION = "description";
	final static String COLUMN_CLASSES_DATE = "lecturedate";
	final static String COLUMN_CLASSES_TIME = "lecturetime";
	...
	public long insertClassRoom(String name, Double lat, Double lon) {
		...
		return db.insert(DB_NAME, null, vals);
	}
	
	public List<ClassRoom> getClassRooms() {
		List<ClassRoom> classRooms = new ArrayList<ClassRoom>();
		Cursor cursor = db.query("classrooms", classRoomColumns, null, null, null, null, null);
		cursor.moveToFirst();
